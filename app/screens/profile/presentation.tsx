...
You can however, request the removal of specific Anonymous ID information from our logs at any time`}
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: 15 }}>
                  <Text style={{ fontSize: responsiveFontSize(12), color: "#A2ABB8", fontWeight: "500", width: '85%' }}>{`All this information can help improve the accuracy of our calibration process. Additionally it is used for calculating Caloric Burn & Heart Rate Zones.`}</Text>
                  <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        <Popable caretPosition="right" backgroundColor={color.palette.mainBgColor} style={{ width: 300 ,borderRadius: 16,}} position="right" content={<View style={{
                          ...
                          <Text style={{
                            ...
                            textAlign: "auto"
                              ...
                              `Your ride history, your personalized calibrations will be backed up and associated with your Anonymous ID.

To restore your ride history and calibrations you will need to be able to provide your Anonymous ID. Please store this somewhere where you can access it should you lose access to your phone`
                            }</Text>
                        </View>}>
                          <Text style={{ color: "#fff", fontWeight: "900", backgroundColor: "#0399A5", paddingHorizontal: 8, borderRadius: 40, fontSize: 14 }}>?</Text>
                        </Popable>
